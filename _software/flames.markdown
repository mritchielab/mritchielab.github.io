...
papers:
    ...
    - 
        name: Igniting full-length isoform analysis in single-cell and spatial RNA-seq data with FLAMESv2
        url: https://www.biorxiv.org/content/10.1101/2025.10.19.683327v3
icon: flames.png
description: A framework for performing single-cell, spatial and bulk long-read pipeline for splicing and variant analysis
---
